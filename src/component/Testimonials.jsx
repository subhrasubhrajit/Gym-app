        ...
        <section className='testimonials'>
            <div className="container testimonials_container">
                ...
                <div className="testimonials_btn-container">
                    <div className="testimonials_btn" onClick={prevTestimonialHandler}><IoIosArrowDropleftCircle /></div>
                    <div className="testimonials_btn" onClick={nextTestimonialHandler}><IoIosArrowDroprightCircle /></div>
                </div>
            </div>
        </section>
    )
